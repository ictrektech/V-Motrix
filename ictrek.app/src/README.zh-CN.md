...
应用数据由 VOS App Storage 管理。下载文件由 `VOS_MOTRIX_DOWNLOAD_PUBLIC_PATH` 映射到公共目录，默认根目录为 `/data/vos_workspace/v-motrix/downloads`；目录内按 VOS 用户哈希继续隔离，便于在 VOS 文件管理中直接取得下载结果。
